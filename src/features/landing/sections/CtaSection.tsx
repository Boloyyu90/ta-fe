                        ...
                        <div className="relative px-8 py-16 sm:px-12 sm:py-20 text-center">
                            <div className="max-w-3xl mx-auto space-y-8">
                                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
                                    Siap Memulai Perjalanan Sukses CPNS?
                                </h2>

                                <p className="text-lg text-white/90 leading-relaxed">
                                    Bergabung dengan ribuan peserta yang telah meningkatkan hasil ujian mereka dengan simulasi
                                    realistis dan proctoring berbasis AI.
                                </p>
                                ...
                                <div className="pt-8">
                                    <p className="text-sm text-white/80">Gratis 14 hari • Tanpa kartu kredit • Batalkan kapan saja</p>
                                </div>
                            </div>
                        </div>
                    </div>
