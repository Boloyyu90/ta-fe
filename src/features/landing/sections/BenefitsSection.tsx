                  ...
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <div className="relative lg:col-start-2 z-10">
                        <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto bg-background flex items-center justify-center rounded-full">
                          <div className="w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-primary text-white flex items-center justify-center rounded-full text-lg sm:text-xl font-bold">
                            {benefit.step}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className={cn(
                        ...
                        <div className="space-y-1 sm:space-y-2">
                          <h3 className="uppercase text-muted-foreground text-xs sm:text-sm md:text-base font-semibold">
                            {benefit.title}
                          </h3>
                          <h4 className="uppercase text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-foreground">
                            {benefit.subtitle}
                          </h4>
                        </div>
                        <p className="text-muted-foreground mt-2 sm:mt-3 text-xs sm:text-sm md:text-base max-w-xs sm:max-w-sm md:max-w-md lg:max-w-sm mx-auto lg:mx-0 leading-relaxed">
                          {benefit.description}
                        </p>
                      </div>
                    </div>
